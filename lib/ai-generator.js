  ...
  const prompts = {
    ...
    "ending-explained": `Generate a deep-dive "Ending Explained" article of 1200-1500 words for "${movieTitle}" (${releaseYear}). The focus is on analysis, symbolism, and thematic interpretation.
      ...
      **Core Instructions:**
      ...
      - **Formatting:** Use Markdown with H2 for main sections and H3 for sub-sections. Paragraphs must be detailed and well-supported.
    ...
    "budget": `Generate a detailed breakdown of the budget for "${movieTitle}" (${releaseYear}). The article must be 1000-1200 words.
    ...
    "ott-release": `Generate a comprehensive guide about the OTT release of "${movieTitle}" (${releaseYear}). The article must be 1000-1200 words.
