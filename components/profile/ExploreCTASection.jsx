        ...
        <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <button 
              ...
              className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-cyan-500 to-cyan-400 text-white font-semibold rounded-full hover:from-cyan-400 hover:to-cyan-300 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
              <span>📈</span>
