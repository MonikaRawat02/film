  ...
  return (
    <section className="font-sans">
      <div className="relative mx-auto max-w-[1055px] px-4 sm:px-6 lg:px-8 pt-20 pb-12 text-center">
        ...
        <div className="max-w-3xl mx-auto scrollbar-transparent">
          <div className="relative group scrollbar-transparent">
            <div className="absolute inset-0 bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 scrollbar-transparent" />
            <div className="relative bg-zinc-900/90 backdrop-blur-xl border border-zinc-800 rounded-2xl overflow-hidden scrollbar-transparent">
              <input
                type="text"
                value={searchQuery}
                ...
                className="w-full h-16 bg-transparent border-0 px-6 py-5 text-white placeholder-zinc-500 focus:outline-none focus:ring-0 scrollbar-transparent"
              />
            ...
            {isFocused && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-zinc-900/95 backdrop-blur-xl border border-zinc-800 rounded-2xl p-4 shadow-2xl z-50 max-h-[400px] overflow-y-auto scrollbar-transparent">
