...
export default function RelatedIntelligence({ celebrityA, celebrityB }) {
  const cards = [
    {
      title: `Full profile of ${celebrityB?.heroSection?.name || "Celebrity"}`,
      desc: "Explore complete biography, filmography, and career insights",
      img: celebrityB?.heroSection?.profileImage || "https://images.unsplash.com/photo-1608571425696-95bdfcaa78e0?q=80&w=1200&auto=format&fit=crop",
      href: celebrityB ? `/celebrity/${celebrityB.heroSection.slug}/profile` : "#",
    },
    {
