...
export default function HollywoodHeroSection() {
  return (
    <section className="relative overflow-hidden min-h-screen flex items-center bg-[#0b0f1a]">
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 py-16 md:py-24 w-full">
        <div className="text-center max-w-4xl mx-auto flex flex-col items-center">
          ...
          {/* 6. Description Box */}
          <div className="max-w-3xl mx-auto p-6 rounded-2xl border border-white/10 bg-[#121826]/80 backdrop-blur-[10px] text-gray-300 text-sm leading-relaxed text-center">
            <p>
