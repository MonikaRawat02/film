// //pages/admin/celebrity/index.jsx
// "use client";
...
//   Users, ArrowLeft, ArrowRight, UploadCloud
// } from "lucide-react";
...
//       : String(f.heroSection.profession || "")
//         .split(",")
//         .map((s) => s.trim())
//         .filter(Boolean);
...
//       : String(f.quickFacts.profession || "")
//         .split(",")
//         .map((s) => s.trim())
//         .filter(Boolean);
...
//       const res = await fetch("/api/admin/celebrity/create", {
//         method: "POST",
//         headers: {
...
//       if (!res.ok) {
//         setError(data.message || "Failed to create celebrity");
//         setSubmitting(false);
//         return;
//       }
//       setSuccess("Celebrity created successfully!");
//       setSubmitting(false);
//       setOpen(false);
//       setActiveTab(0);
//       // Reset form...
...
//   const InputField = ({ icon: Icon, label, required, hint, ...props }) => {
...
//     );
//     useEffect(() => {
//       setLocalValue(typeof props.value === "number" ? String(props.value) : (props.value ?? ""));
...
//             name={id}
//             className={`w-full rounded-lg bg-gray-900/50 border border-gray-800 ${Icon ? 'pl-10' : 'px-4'
//               } px-4 py-3 text-sm text-gray-200 placeholder-gray-600 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all hover:border-gray-700 appearance-none cursor-pointer`}
//           >
//             {children}
//           </select>
...
//               </div>
//               <div className="h-32 rounded-xl bg-gradient-to-b from-gray-900 to-gray-900/50 border border-gray-800 grid place-items-center">
//                 <div className="text-center">
//                   <p className="text-sm text-gray-500">No celebrity selected</p>
//                   <p className="text-xs text-gray-600 mt-1">Search and select a celebrity to update</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                   </div>
//                   <div>
//                     <h3 className="text-lg font-semibold text-gray-200">Create New Celebrity Profile</h3>
...
// Rest of your components (ArrayCard, SectionCard) can stay inside if they don't cause focus issues
const ArrayCard = ({ children, onRemove, title }) => (
  <div className="relative p-4 bg-gray-900/30 border border-gray-800 rounded-lg hover:border-gray-700 transition-colors">
    {title && <h4 className="text-sm font-medium text-gray-300 mb-3">{title}</h4>}
    <button
