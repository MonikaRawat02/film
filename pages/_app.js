        ...
        <div className="fixed top-0 left-0 w-full h-screen z-[9999] flex items-center justify-center pointer-events-none bg-[#050505]/20 backdrop-blur-[2px]">
          <div className="flex flex-col items-center justify-center -mt-8">
            <div className="relative h-14 w-14">
              ...
              <div className="absolute inset-0 rounded-full border-4 border-[#ef4444] border-t-transparent animate-spin shadow-[0_0_20px_rgba(239,68,68,0.2)]"></div>
            </div>

            <p className="mt-4 text-[10px] font-black uppercase tracking-[0.2em] text-[#ef4444] animate-pulse">
              Loading...
            </p>
          </div>
        </div>
